...
;  File "QtXml4.dll"
  File "cmakeqt.exe"
  File "@CMAKE_SOURCE_DIR@/share/cmakeqt.ico"
  ...
  ;${registerExtension} "$INSTDIR\cmakeqt.exe" ".bbf" "Bla bla file format"
...
Section "Start Menu Shortcuts"
  ...
  CreateShortCut "$SMPROGRAMS\@PROJECT_NAME_LONG@\@PROJECT_NAME_SHORT@.lnk" "$INSTDIR\cmakeqt.exe" "" "$INSTDIR\cmakeqt.ico" 0
...
Section "Desktop Shortcut"
  ...
  CreateShortCut "$DESKTOP\@PROJECT_NAME_LONG@.lnk" "$INSTDIR\cmakeqt.exe" "" "$INSTDIR\cmakeqt.ico" 0
